...
public class EmailController {
    ...
    public ResponseEntity<Object> getContentById(@PathVariable Long id) {
        ...
        @PostMapping("/emails/ban/{id}")
        public ResponseEntity<String> banEmail(@PathVariable Long id) {
            emailService.markEmailAsBanned(id);
            return new ResponseEntity<>("Email marked as banned", HttpStatus.OK);
        }
    }
